...
export default function BookingForm() {
  ...
  useEffect(() => {
    ...
    if (opplevelseParam) {
      ...
      setFormData((prev) => ({
        ...prev,
        opplevelse: values.filter((v) => ['rib', 'batleje', 'badstue'].includes(v)),
      }));
    }
  }, [searchParams]);
        ...
        <div className="container">
          <div className="reveal" style={{ textAlign: 'center' }}>
            <div className="response-badge">
              <span className="response-badge__dot" aria-hidden="true"></span>
              {t('responseBadge')}
            </div>
                    ...
                    <div className="form-checkboxes">
                      <label className="form-checkbox">
                        <input
                          ...
                          name="opplevelse"
                          value="rib"
                          checked={formData.opplevelse.includes('rib')}
                          onChange={() => handleCheckboxChange('rib')}
                        />
                        <span>{t('experienceRib')}</span>
                      </label>
                      <label className="form-checkbox">
                        <input
                          type="checkbox"
                  ...
                  <div className="form-row form-row--2col">
                    <div className="form-group">
                      <label htmlFor="dato" className="form-label">
                        {t('labelDate')} <span aria-hidden="true">*</span>
                      </label>
                      <input
                        type="date"
                        id="dato"
                        ...
                        style={errors.dato ? { borderColor: '#D93025' } : {}}
                      />
                      <span className="form-error" role="alert">
                        {errors.dato || ''}
                      </span>
            ...
            <div className="booking-sidebar">
              ...
              <div className="sidebar-card">
                ...
                <div className="sidebar-contact-item" style={{ cursor: 'default' }}>
                  ...
                  <address style={{ fontStyle: 'normal' }}>Bryggen 12, 5003 Bergen</address>
                </div>
              </div>
              ...
              <div className="sidebar-card">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-2)' }}>
                  ...
                  >
                    ...
                    <span style={{ fontWeight: 'var(--weight-medium)' as unknown as number, color: 'var(--text-primary)' }}>
                      08:00 – 20:00
                    </span>
                  </div>
                  <div style={{ fontSize: 'var(--text-sm)', color: 'var(--text-muted)' }}>
                    {t('sidebarHoursSeason')}
                  </div>
                </div>
              </div>
          ...
          <div className="faq reveal" role="list">
            {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
              <details key={i} role="listitem">
                ...
                <div className="faq__answer">{t(`faq${i}Answer`)}</div>
              </details>
            ))}
          </div>
        </div>
